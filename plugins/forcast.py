...
def forcast(args, nick, channel, c, e):
    ...
    if location is not False:
        ...
        return "%s: 即时天气 %s 实时温度 %.2f℃ 体感温度 %.2f℃ 降水概率 %d%% 湿度 %d%% 短时预报 %s 本周天气 %s" \
               % (nick, js1['currently']['summary'], js1['currently']['temperature'], js1['currently']['apparentTemperature'],
                  js1['currently']['precipProbability']*100, js1['currently']['humidity']*100, js1['hourly']['summary'], js1['daily']['summary'])
    else:
